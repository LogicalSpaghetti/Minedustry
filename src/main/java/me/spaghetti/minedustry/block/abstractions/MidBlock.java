...
import me.spaghetti.minedustry.util.enums.Category;
...
// every variable, taken almost straight from Mindustry
public abstract class MidBlock extends BlockWithEntity implements BlockEntityProvider {
...
/*    *//** Array of consumers used by this block. Only populated after init(). *//*
    ...
    *//** The single power consumer, if applicable. *//*
    ...
    protected MidBlock(Settings settings) {
        super(settings);
    }
}
